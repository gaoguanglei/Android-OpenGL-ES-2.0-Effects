...
void opengl_init(int w, int h)
{
	...
	/**********************************************************************************/
	plane_mesh.texs_idxs[0] = create_texture("media/Terrain.tga");
	...
	g_Load3ds.Import3DS(&g_3DModel, "media/Disc.3ds");
	LOGI("load 3ds end");
...
void opengl_display()
{
	...
	view_matrix.look_at(vec3(0,20,distance_y), vec3(0,0,0), vec3(0,1,0));
